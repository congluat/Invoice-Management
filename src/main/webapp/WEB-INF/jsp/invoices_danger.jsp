...
<div class="row"
	...
	<div ng-controller="InvoiceDangerController">
		...
		<div class="col-md-12">
			...
			<div class="row">
				...
				<btn class="col-md-4 btn btn-primary" ng-click="loadMore()" ng-disabled="isDisabled" ng-model="isDisabled"> <strong>{{MoreInvoices}}</strong></btn>
